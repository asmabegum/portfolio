...
const mainBody = {
  ...
  firstName: "Asma Begum",
  middleName: "",
  lastName: "Razick",
  message: " Passionate to be part of AI generation ",
  icons: [
    {
      image: "fa-github",
      url: "https://github.com/asmabegum/Projects",
    },
    {
      image: "fa-linkedin",
      url: "https://www.linkedin.com/in/asma-begum-razik-45870b95/",
    },
  ],
};
...
const about = {
  ...
  imageSize: 375,
  message:
    "My name is Asma Begum, holds Masters in Statistics and experienced in Data Analytics field for 9 years. I did projects in Dashboard creation, Data Pipeline and Architechture in cloud, Model dbuilding in Machine Learning and Artificial Intelligence.",
...
const repos = {
  ...
  gitHubUsername: "asmabegum", //i.e."johnDoe12Gh"
  reposLength: 4,
  specificRepos: ["Projects"],
};
...
const leadership = {
  ...
  images: [
    { 
      img: require("../editable-stuff/asma.png"), 
